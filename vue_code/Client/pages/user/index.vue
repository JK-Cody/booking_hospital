...
export default {
  data() {
    return {
      userAuth: defaultForm,  //身份信息
      certificatesTypeList: [],
      fileUrl:'http://localhost:8000/api/oss/file/fileUpload',  //文件上传接口地址
      userInfo: {
        param: {}
      },
      submitBnt: '提交'
  ...
  methods: {
    ...
    saveUserAuth() {
      ...
      this.submitBnt = '正在提交...'
      loginApi.saveUserAuth(this.userAuth).then(response => {
    ...
    getDict() {
      dictApi.getChildDataByDictCode("CertificatesType").then(response => {
