package com.hospital.gateway.fliter;
...
public class AuthGlobalFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //设置Feign模块的内部访问方法的路径
        if(antPathMatcher.match("/**/inner/**", path)) {    //拦截含有inner的路径
        ...
        //异步请求，校验用户必须登录
        if(antPathMatcher.match("/api/**/auth/**", path)) {   //拦截含有api和auth的路径
