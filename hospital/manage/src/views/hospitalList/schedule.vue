...
export default {
    ...
    methods:{
        fetchData() {
            hospApi.departmentList(this.hoscode)
                .then(response => {
    ...
    //单个排班详细
     getDetailSchedule() {
            hospApi.scheduleDetail(this.hoscode,this.depcode,this.workDate)
                .then(response => {
    ...
    //排班列表
    getScheduleRule() {
      hospApi.scheduleList(this.page, this.limit, this.hoscode, this.depcode).then(response => {
